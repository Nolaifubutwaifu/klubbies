...
export function LogoUploader({ clubId, logoUrl }: { clubId: string; logoUrl: string | null }) {
  ...
  return (
    ...
    >
      ...
      <span className="font-heading text-[15px] font-extrabold text-neutral-800">{busy ? "Uploading…" : logoUrl ? "Replace logo" : "Drop your logo"}</span>
      <span className="text-[13px] text-neutral-700">PNG or SVG, at least 400px</span>
